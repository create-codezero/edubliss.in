...
<div class="sector flex flex-column e-c m-y-30">
     ...
     $check_channel_query = " SELECT * FROM `78000_wagroups` ";
          ...
          ?>
                    <div class="box flex p-y-20 flex-y-center m-20 mob-flex-column overflow-hidden pos-relative" style="justify-content: space-between; background-color: #abff9e;" id="ad-preview">
