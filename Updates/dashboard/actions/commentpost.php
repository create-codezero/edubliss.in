...
if (isset($_POST['commentSubmited'])) {
     ...
     if ($fireInsertingComment) {
          ...
          $gettingPostUserDetails = "SELECT `userId`, `userUniqueCode`, `userFullName`, `userEmail` FROM `78000_posts` WHERE `postSrNo` = '$commentPost'";
          ...
          echo "Comment Added!";
				...
				try {
					...
					//Content
					$mail->isHTML(true);
					$mail->Subject = 'Your Post got a Comment...';
					$mail->Body    = '
                              <!DOCTYPE html
		...
		<table class="main" style="border-spacing: 0; width: 100%; max-width: 600px; background-color: #ffffff; margin: 0 auto;" width="100%" bgcolor="#ffffff">
					...
					<table style="border-spacing: 0; width: 100%;" width="100%">
						<tr>
							<td style="font-family: "Poppins", sans-serif; text-align: center; padding: 40px 0;" align="center">
								<a href="javascript:void(0)"><img src="	https://www.edubliss.in/media/Mail/undraw_Public_discussion_re_w9up.png" alt="Comment" title="EduBliss Logo" style="border: 0; max-width: 300px; width: 90%;"></a>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				...
				<strong style="font-weight: 600; color: #FFAA48;">
                         Click on the View button to see Comment.
                    </strong><br><br>
                         </p>
							</td>
						</tr>
