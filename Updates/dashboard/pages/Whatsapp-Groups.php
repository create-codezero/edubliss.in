...
<div class="sector flex flex-column e-c m-y-30">
     ...
     $check_channel_query = " SELECT * FROM `78000_wagroups` ";
          ...
          ?>
                    <div class="box flex p-y-20 flex-y-center m-20 mob-flex-column overflow-hidden pos-relative" style="justify-content: space-between; border: 1.5px solid var(--clr-3);" id="ad-preview">
