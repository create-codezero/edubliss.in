...
if(!isset($_GET['assignment']) && !isset($_GET['subject'])){
    header("location: ./");
}
...
<div class="flex e-c w-100per flex-d-column" style="min-height: 75vh;">
     ...
     <div class="flex flex-d-column e-c" style="max-width: 600px; width:95%;">
          ...
          $gettingAllQuestions = "SELECT * FROM `78000_questions` WHERE `assignment` = '$assignment' AND `subject` = '$subject' ORDER BY `questionId` DESC";
