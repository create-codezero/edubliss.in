...
$_SESSION['adminDPage'] = "User-Assets";
$searchBoxValue = "";
$sql = "SELECT * FROM `78000_assets` WHERE `uploadedBy` = 'User' AND `assetStatus` = 'Admin' ORDER BY assetId DESC";
...
<div class="sector w-100per">
     ...
     <div class="grid grid-column-4 tab-grid-column-2 mob-grid-column-1  grid-gap-15 m-20 mob-m-10">
          ...
          ?>
                    ...
                    <div class="w-100per asset-card">
                         <div class="thumbnail">
                            ...
                            if(empty($row['assetThumbnail']) OR $row['assetThumbnail'] = ""){
                                ?>
                                <div class="flex e-c" style="min-height: 204.23px; background-color:white; border:3.5px solid var(--clr-2); border-radius:12px;">
                         ...
                         <div class="call-to-action m-t-5 block tx-center">
                              ...
                              <p class="fc-light-dark-blue font-poppins fw-600 fs-10 m-b-10">Visibility : <?php echo $row['assetStatus']; ?></p>
                              ...
                              <div class="bg-clr-4 w-100per flex e-c">
                                   <i class="fa fa-check cursor-pointer fs-20 hover-bg-dark-blue hover-fc-primary fc-dark-white icon<?php echo $row['assetId']; ?>" onclick="approveAsset('<?php echo $row['assetId']; ?>')" style="width: max-content; max-height: 100px; height: 100%; padding: 12px 20px; border-right:1px solid var(--clr-11);"></i>
          ...
          <?php
               ...
               echo '<p class="tx-center font-poppins fw-500">🙄 Search Maths | No Assets Found 🙄 </p>';
          }
          ?>
     </div>
</div>