...
if (isset($_POST['postText'])) {
     ...
     $userEmail = $_SESSION['userDetails'][2];
     $likeCount = 0;
     ...
     $userStatus = $_SESSION['userDetails'][11];
     ...
     $insertStage1 = "INSERT INTO `78000_posts`(`postSrNo`, `postText`, `postImage`, `postRating`, `postPoll`, `totalLike`, `userId`, `userUniqueCode`, `userFullName`, `userLogo`,`userEmail`,`postByUserStatus`, `postTime`) VALUES ('$srNo','$postText','false','false','false','$totalLike','$userId','$userUniqueCode','$userFullName','$userLogo','$userEmail','$userStatus','$dateTime')";
